#' (Deprecated) Make ggplot errorbars and mean with a single function
#'
#' \strong{Deprecated! Use \code{\link{geom_errorbars}} instead!} \cr
...
#' (Deprecated)Make dotplots with errorbars with a single function
#'
#' \strong{Deprecated! Use \code{\link{geom_dots_and_bars}} instead!} \cr
